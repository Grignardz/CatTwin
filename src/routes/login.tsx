      ...
      >
        ...
        <motion.div variants={childVariants} className="relative px-6 pt-8 pb-0 z-10">
          ...
          <p className="text-sm text-muted-foreground mt-2">
            Sign in to continue tracking your cat's health.
          </p>
        </motion.div>
            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-4">
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    to="/forgot-password"
                    className="text-xs text-[var(--coral)] hover:underline underline-offset-2"
                  >
                    Forgot password?
                  </Link>
                </div>
                <div
                  className={`mt-1.5 flex items-center gap-2 bg-secondary rounded-xl px-3 py-0 border transition-colors ${showPassError ? "border-red-400 dark:border-red-500" : "border-transparent focus-within:border-[var(--coral)]"}`}
                >
