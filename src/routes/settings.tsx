...
function ChangePasswordModal({ onClose }: { onClose: () => void }) {
  ...
  const fieldCls =
    "w-full bg-background rounded-xl px-3 py-2.5 text-sm outline-none border border-border focus:ring-2 focus:ring-[var(--coral)]";
          ...
          {editingId === cat.id ? (
            <form onSubmit={handleEditSave} className="bg-secondary rounded-2xl p-3 space-y-2">
              ...
              {photo && (
                <button
                  ...
                  className="block mx-auto text-xs text-muted-foreground hover:text-red-500 transition-colors"
                >
                  Remove photo
                </button>
              )}
              ...
              <div className="flex gap-2 pt-1">
                ...
                <button
                  type="submit"
                  className="flex-1 bg-[var(--coral)] text-white rounded-xl py-2 text-sm font-medium"
                >
                  Save
                </button>
              </div>
            ...
            <div className="flex items-center gap-3 bg-secondary rounded-2xl p-3">
              ...
              <Link
                ...
                aria-label={`Full profile for ${cat.name}`}
              >
                <FileText size={13} />
              </Link>
              <button
...
function Settings() {
  ...
  const [browserNotif, setBrowserNotif] = useState(
    user?.preferences?.browserNotifications ?? false,
  );
      ...
      <div className="px-6 space-y-5 pb-6">
        ...
        <div className="bg-card rounded-3xl p-5 shadow-[0_4px_16px_-8px_rgba(0,0,0,0.1)]">
            ...
            <div className="relative">
              <div className="w-16 h-16 rounded-full bg-[var(--coral-soft)] overflow-hidden flex items-center justify-center">
                {user?.avatar && !avatarBroken ? (
                  ...
                  <UserIcon size={28} className="text-[var(--coral)]" strokeWidth={1.75} />
                )}
              </div>
              <button
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="text-xs text-[var(--coral)] underline underline-offset-2"
            >
              Change password
            </button>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link to="/notifications" className="text-xs text-[var(--coral)] font-medium">
                  View all
                </Link>
              </div>
                ...
                {[
                  {
                    ...
                    set: (v: boolean) => {
                      setNotifVet(v);
                      updateUser({ preferences: { notifVet: v } });
                    },
                  },
                  {
                    label: "Weight & health alerts",
                    on: notifWeight,
                    set: (v: boolean) => {
                      setNotifWeight(v);
                      updateUser({ preferences: { notifWeight: v } });
                    },
                  },
                  {
                    ...
                    set: (v: boolean) => {
                      setNotifFeeding(v);
                      updateUser({ preferences: { notifFeeding: v } });
                    },
                  },
                ].map((n) => (
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-[10px] text-muted-foreground/70 mt-0.5 max-w-[200px]">
                      Native pop-ups while this tab is open
                    </p>
                  </div>
              ...
              <div className="flex gap-2 mt-2">
                {(["kg", "lbs"] as const).map((u) => (
                  <button
                    ...
                    onClick={() => {
                      setUnits(u);
                      updateUser({ preferences: { units: u } });
                    }}
              ...
              <div className="flex gap-2 mt-2">
                {(["MM/DD/YYYY", "DD/MM/YYYY"] as const).map((f) => (
                  <button
                    ...
                    onClick={() => {
                      setDateFormat(f);
                      updateUser({ preferences: { dateFormat: f } });
                    }}
        ...
        <div className="bg-card rounded-3xl p-5 shadow-[0_4px_16px_-8px_rgba(0,0,0,0.1)]">
          ...
          <div className="space-y-3">
            <Link
              to="/reports"
              className="w-full flex items-center justify-between bg-secondary rounded-xl px-4 py-3 text-sm font-medium active:scale-95 transition-transform"
            >
            ...
            {!deleteConfirm ? (
              ...
              <div className="bg-red-100 dark:bg-red-900/30 rounded-xl p-4 animate-in slide-in-from-top-1 duration-200">
                ...
                <p className="text-xs text-red-600 dark:text-red-400 mb-4 leading-relaxed">
                  This will permanently remove all health logs, feeding records, vet history, chat
                  conversations, and dismissed notifications. This cannot be undone.
                </p>
